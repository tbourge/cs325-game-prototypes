...
class MyScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.robot = new Robot(this, this.getCoord(3), this.getCoord(4), this.rockets, this.hook);
...
class Rope extends Phaser.GameObjects.Sprite {
    ...
    make(x, y) {
        ropes++;
        this.setAngle(this.hook.dir * 90);
        this.x = x;
        this.y = y;
        this.setActive(true);
...
class Tank extends Phaser.Physics.Arcade.Sprite {
    ...
    preUpdate(time, delta) {
        ...
        if (this.hook != null && this.isPulled) {
            this.fakex = this.hook.x;
            this.fakey = this.hook.y;
            this.slide.play();
        }
