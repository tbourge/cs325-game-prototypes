...
class MyScene extends Phaser.Scene {
    ...
    create() {
        ...
        scoreText = this.add.text(200, 300, "", { fontSize: "32px", color: "0x000000" });
        ...
        this.cannonSound = this.sound.add('cannonSound', { volume: 0.4, rate: 1.0 });
